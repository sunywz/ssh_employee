	...
	<s:form action="employee_update" method="post" namespace="/"
		...
		<table border='0' cellpadding="0" cellspacing="10">
			...
			<tr>
				...
				<td>性别：</td>
				<td><s:radio name="sex" list="{'男','女'}" value="%{model.sex}" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>用户名：</td>
				<td><s:textfield name="username" value="%{model.username}" />
				</td>
				<td>密码：</td>
			...
			<tr>
				...
				<td><s:select name="department.did" list="list" listKey="did"
						listValue="dname" headerKey="" headerValue="--请选择--"
						value="%{model.department.did}" /></td>
				<td>编号：</td>
